...
import {
    LayoutDashboard, Users, Settings, Bell, Search, Box, Shield,
    ArrowLeftRight, Radio, Wallet, Code, UserCheck, Sparkles, ChevronDown, Palette, Landmark
} from 'lucide-react';
import { AhoyLogo } from './AhoyLogo';
...
const MAIN_NAV = [
    { id: 'ahoy', icon: LayoutDashboard, label: 'Dashboard' },
    { id: 'dashboard', icon: Box, label: 'Assets' },
    { id: 'identities', icon: UserCheck, label: 'Identities' },
    { id: 'policies', icon: Shield, label: 'Policy Studio' },
    { id: 'transactions', icon: ArrowLeftRight, label: 'Transactions' },
    { id: 'oracles', icon: Radio, label: 'Oracles' },
    { id: 'payouts', icon: Wallet, label: 'Payouts' },
];

const DEV_NAV = [
    { id: 'institutional', icon: Landmark, label: 'Dubai RE Demo' },
    { id: 'developers', icon: Code, label: 'Developers' },
    { id: 'uikit', icon: Palette, label: 'UI Kit Demo' },
    { id: 'demo', icon: Sparkles, label: 'SDK Demos' },
    { id: 'settings', icon: Settings, label: 'Settings' },
];

export function Layout({ children, activeTab, onTabChange }: LayoutProps) {
    const renderNavButton = (item: typeof MAIN_NAV[0]) => {
