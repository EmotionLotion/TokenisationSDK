...
class SimpleSmartAccount implements ISmartAccount {
  ...
  async deploy(): Promise<import('../../core/types.js').Result<import('../interfaces/UserOperation.js').UserOperation, string>> {
    if (this._isDeployed) {
  ...
  ): Promise<import('../../core/types.js').Result<void, string>> {
    // Basic validation
