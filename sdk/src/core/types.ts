...
export enum EventType {
  ...
  // ACE (Automated Compliance Engine) events
  ACE_ATTESTATION_REQUESTED = 'ACE_ATTESTATION_REQUESTED',
  ACE_ATTESTATION_FULFILLED = 'ACE_ATTESTATION_FULFILLED',
  ACE_ATTESTATION_EXPIRED = 'ACE_ATTESTATION_EXPIRED',
  ACE_ATTESTATION_REVOKED = 'ACE_ATTESTATION_REVOKED',
  ACE_FALLBACK_TRIGGERED = 'ACE_FALLBACK_TRIGGERED',
  ACE_TRANSFER_COMPLIANCE_PASSED = 'ACE_TRANSFER_COMPLIANCE_PASSED',
  ACE_TRANSFER_COMPLIANCE_FAILED = 'ACE_TRANSFER_COMPLIANCE_FAILED',
}
