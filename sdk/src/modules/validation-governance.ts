...
// ============================================================================
// DLD (DUBAI LAND DEPARTMENT) MODULE SCHEMAS
// ============================================================================

export const TitleDeedStatusSchema = z.enum([
  'VALID',
  'EXPIRED',
  'PENDING',
  'REVOKED',
...
export const NotifyTokenizationInputSchema = z.object({
  propertyId: z.string().min(1, 'Property ID is required'),
  deedNumber: z.string().min(1, 'Deed number is required'),
  tokenContractAddress: EthereumAddressSchema,
  totalSupply: z.string().regex(/^[0-9]+$/, 'Total supply must be a positive integer'),
...
export const ListDldEventsParamsSchema = PaginationSchema.extend({
  propertyId: z.string().optional(),
