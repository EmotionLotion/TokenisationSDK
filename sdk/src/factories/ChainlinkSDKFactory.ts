...
import { CCIPSettlementProvider } from '../providers/settlement/CCIPSettlementProvider.js';
import type { CrossPackEventBus } from '../orchestration/CrossPackEventBus.js';
...
export function createChainlinkWiredSDK(config: ChainlinkWiringConfig): ChainlinkWiredSDK {
  ...
  if (config.ccip?.enabled) {
    ...
    settlementProvider = new CCIPSettlementProvider(ccipPlugin);
  }
