 ...
 *
 * Moved from @tokenisation/core to @tokenisation/pack-supply-chain.
 */
...
interface AssetSchema {
  type: 'object';
  required: string[];
  properties: Record<string, { type: string; description?: string; format?: string; enum?: string[]; minimum?: number; maximum?: number; items?: { type: string } }>;
}
