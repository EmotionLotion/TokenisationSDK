...
/**
 * Create default policy registry.
 *
 * Returns an empty registry. Vertical packs (e.g. @tokenisation/realestate)
 * are responsible for registering their own domain-specific policies.
 */
